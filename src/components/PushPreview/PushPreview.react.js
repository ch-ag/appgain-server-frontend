...
import SegmentSelect      from '../SegmentSelect/SegmentSelect.react';
import styles             from './PushPreview.scss';
import VisiblePreview     from './VisiblePreview.react';
import {
         getDateMethod,
         MONTHS,
         pad,
      ...
      <div className={styles.wrap}>
        <div className={styles.left}>
          <div className={styles.section}>
            ...
            <Row label='Sending to:' content={audienceName} />
          </div>
          {messagePreview}
          {timePreview}
        </div>
